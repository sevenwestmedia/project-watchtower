...
import { BuildParam, StartParam, WatchParam } from '..'
import { cliLogger } from '../utils/log'
...
const buildConfig = getBuildConfig(cliLogger, workingDirectory)
...
switch (command) {
    ...
    case 'clean':
        exitAfter(binClean(cliLogger, buildConfig, ...commandArgs))
        break
